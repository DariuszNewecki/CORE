...
class TestConvenienceFunctions:
    ...
    def test_create_crate_from_spec_success(self, mock_settings):
        """Verify convenience function creates crate."""
        files = {"src/test.py": "pass"}
        metadata = {"tokens": 100}
        crate_id = create_crate_from_spec(
    ...
    def test_create_crate_from_spec_validates_paths(self, mock_settings):
