...
CONSTITUTIONAL ENHANCEMENT V2.5:
- Added refusals inspection commands for constitutional compliance auditing
"""
...
# ============================================================================
# CONSTITUTIONAL REFUSALS (NEW)
# ============================================================================

@inspect_app.command("refusals")
@command_meta(
...
@inspect_app.command("refusal-stats")
@command_meta(
...
@inspect_app.command("refusals-by-type")
@command_meta(
...
@inspect_app.command("refusals-by-session")
@command_meta(
...
@async_command
@core_command(dangerous=False, requires_context=False)
# ID: refusals_by_session_command
