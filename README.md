...
[![Release](https://img.shields.io/badge/Release-v2.9.0-blue)](https://github.com/DariuszNewecki/CORE/releases)
...
252 rules across 56 rule documents. All 252 are mapped to enforcement engines; 0 test-quality rules are still pending mappings. "Mapped" means engine-bound — not enforced in every mode: stateless CI skips `knowledge_gate` and `llm_gate`, which need the knowledge graph and an LLM provider.
...
**Current Release:** v2.9.0 — CLI Client Parity
