# src/body/self_healing/logging_service.py
"""
AST-based automated remediation for logging standards violations.

Moved from src/cli/commands/fix_logging.py under ADR-050 (CLI is outside
CORE; Will may not import from CLI). The CLI module retains a deprecated
