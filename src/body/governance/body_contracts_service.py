# src/body/governance/body_contracts_service.py
"""
Body Contracts Checker
Static validator for `.intent/patterns/body_contracts.json`.

Moved from src/cli/logic/body_contracts_checker.py under ADR-050 (CLI is
outside CORE; Will may not import from CLI). The CLI module retains a
deprecated re-export shim for in-CLI callers; the canonical implementation
lives here.

Scans Mind, Body, and Will layers for UI leaks.
"""
