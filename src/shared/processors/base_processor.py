...
"""
Base processor for structured data deserialization.
...
class BaseProcessor(ABC):
    ...
    - load(): Load and parse with error context
    - load_strict(): Load with strict validation

    Abstract Methods (subclasses must implement):
    - _deserialize(): Format-specific load logic
    - _validate_data(): Format-specific validation
    - _format_name(): Format name for logging
    """
