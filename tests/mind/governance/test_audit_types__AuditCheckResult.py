...
def test_audit_check_result_equality():
    ...
    result1 = AuditCheckResult(name='test', category='cat', duration_sec=1.0, findings_count=0, max_severity=None, fix_hint=None, extra=None)
    result2 = AuditCheckResult(name='test', category='cat', duration_sec=1.0, findings_count=0, max_severity=None, fix_hint=None, extra=None)
...
def test_audit_check_result_with_extra_data():
    ...
    extra_data = {'details': 'Additional information', 'count': 42, 'nested': {'key': 'value'}}
    result = AuditCheckResult(name='check_with_extra', category='monitoring', duration_sec=5.5, findings_count=1, max_severity=AuditSeverity.INFO, fix_hint='No action required', extra=extra_data)
