...
from mind.governance.pattern_validator import PatternValidator, PatternViolation, PatternValidationResult
import tempfile
import yaml
import os
...
async def test_validate_with_patterns_loaded():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        pattern_data = {'id': 'test_category', 'patterns': {'test_pattern': {'description': 'Test pattern'}}}
