...
def test_load_available_actions_returns_non_empty_list_when_planner_actions_present(monkeypatch):
...
def test_load_available_actions_returns_empty_list_when_planner_actions_is_empty(monkeypatch):
