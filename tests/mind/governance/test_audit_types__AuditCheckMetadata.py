...
import pytest
from mind.governance.audit_types import AuditCheckMetadata, AuditSeverity
...
def test_audit_check_metadata_with_none_category():
    ...
    metadata = AuditCheckMetadata(id='no_category', name='No Category Check', category=None, fix_hint='some fix')
...
def test_audit_check_metadata_with_whitespace_in_strings():
    ...
    metadata = AuditCheckMetadata(id='  check_id  ', name='  Check Name with\tTabs  ', category='  category  ', fix_hint='fix\nwith\nnewlines')
