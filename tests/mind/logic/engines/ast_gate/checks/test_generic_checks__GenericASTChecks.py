...
class TestGenericASTChecksIsSelected:
    ...
    def test_is_selected_empty_selector_returns_true(self):
        ...
        node = ast.FunctionDef(
            name="test_func", args=ast.arguments(), body=[], decorator_list=[]
        )
    ...
    def test_is_selected_has_decorator_matching(self):
        ...
        node = ast.FunctionDef(
            name="test_func", args=ast.arguments(), body=[], decorator_list=[decorator]
        )
    ...
    def test_is_selected_name_regex_matching(self):
        ...
        node = ast.FunctionDef(
            name="test_function", args=ast.arguments(), body=[], decorator_list=[]
        )
    ...
    def test_is_selected_name_regex_no_match(self):
        ...
        node = ast.FunctionDef(
            name="my_function", args=ast.arguments(), body=[], decorator_list=[]
        )
        selector = {"name_regex": "^test_.*"}
        result = GenericASTChecks.is_selected(node, selector)
        assert not result
...
class TestGenericASTChecksValidateRequirement:
    ...
    def test_validate_requirement_forbidden_calls_no_violation(self):
        ...
        call = ast.Call(
            func=ast.Name(id="allowed_func", ctx=ast.Load()), args=[], keywords=[]
        )
        body = [ast.Expr(value=call)]
        node = ast.FunctionDef(
            name="test_func", args=ast.arguments(), body=body, decorator_list=[]
        )
    ...
    def test_validate_requirement_required_calls_missing(self):
        ...
        call = ast.Call(
            func=ast.Name(id="other_func", ctx=ast.Load()), args=[], keywords=[]
        )
        body = [ast.Expr(value=call)]
        node = ast.FunctionDef(
            name="test_func", args=ast.arguments(), body=body, decorator_list=[]
        ...
        requirement = {
            ...
            "calls": ["self.tracer.record", "required_func"],
        }
        result = GenericASTChecks.validate_requirement(node, requirement)
        assert (
            result
            == "missing mandatory call(s): ['required_func', 'self.tracer.record']"
        )
    ...
    def test_validate_requirement_forbidden_imports_violation_importfrom(self):
        ...
        import_from = ast.ImportFrom(
            module="click", names=[ast.alias(name="command", asname=None)], level=0
        )
        body = [import_from]
        node = ast.FunctionDef(
            name="test_func", args=ast.arguments(), body=body, decorator_list=[]
    ...
    def test_validate_requirement_decorator_args_all_present(self):
        ...
        keywords = [
            ast.keyword(arg="action_id", value=ast.Constant(value="test")),
            ast.keyword(arg="other_arg", value=ast.Constant(value="value")),
        ]
        decorator_call = ast.Call(func=func, args=[], keywords=keywords)
        node = ast.FunctionDef(
            name="test_func",
        ...
        requirement = {
            ...
            "required_kwargs": ["action_id", "other_arg"],
        }
        result = GenericASTChecks.validate_requirement(node, requirement)
        assert result is None
    ...
    def test_validate_requirement_decorator_args_missing(self):
        ...
        requirement = {
            "check_type": "decorator_args",
            "decorator": "atomic_action",
            "required_kwargs": ["action_id", "required_arg"],
        }
        result = GenericASTChecks.validate_requirement(node, requirement)
