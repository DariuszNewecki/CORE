...
class TestCheckTestFileNaming:
    ...
    def test_test_generation_exception(self):
        ...
        result = NamingChecks.check_test_file_naming('/path/to/test_generation/module.py')
        assert result == []
        result = NamingChecks.check_test_file_naming('/test_generation/unittest_module.py')
        assert result == []
