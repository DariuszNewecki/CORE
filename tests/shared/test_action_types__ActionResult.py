...
class TestActionResult:
    ...
    def test_basic_initialization(self):
        ...
        result = ActionResult(
            ...
            ok=True,
            data={"violations_count": 0, "files_scanned": 5},
        )
    ...
    def test_name_property_backwards_compatibility(self):
        ...
        result = ActionResult(
            action_id="generate.docs", ok=True, data={"files_created": ["README.md"]}
        )
    ...
    def test_data_with_non_serializable_content(self):
        ...
        result = ActionResult(
            action_id="test.nonserializable",
            ok=True,
            data={"obj": CustomObject(), "number": 42},
        )
    ...
    def test_complex_nested_data(self):
        ...
        complex_data = {
            "violations": [
                {"file": "/path/to/file.py", "line": 10, "message": "Invalid import"},
                {
            ...
            "summary": {"total": 2, "by_type": {"import": 1, "docstring": 1}},
            "files_scanned": 15,
        }
        result = ActionResult(
            action_id="check.complex", ok=False, data=complex_data, duration_sec=2.3
        )
    ...
    def test_boolean_ok_values(self):
        ...
        result_true = ActionResult(
            action_id="test.true", ok=True, data={"status": "success"}
        )
        assert result_true.ok
        result_false = ActionResult(
            action_id="test.false", ok=False, data={"status": "failed"}
        )
