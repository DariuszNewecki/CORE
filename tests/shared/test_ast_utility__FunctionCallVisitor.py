...
def test_visit_call_with_attribute_node():
    ...
    visitor = FunctionCallVisitor()
    node = ast.Call(func=ast.Attribute(value=ast.Name(id='obj', ctx=ast.Load()), attr='method', ctx=ast.Load()), args=[], keywords=[])
    visitor.visit_Call(node)
...
def test_nested_calls_are_recorded():
    ...
    visitor = FunctionCallVisitor()
    inner_call = ast.Call(func=ast.Name(id='inner', ctx=ast.Load()), args=[], keywords=[])
    outer_call = ast.Call(func=ast.Name(id='outer', ctx=ast.Load()), args=[inner_call], keywords=[])
...
def test_method_chaining():
    ...
    visitor = FunctionCallVisitor()
    method2_call = ast.Call(func=ast.Attribute(value=ast.Call(func=ast.Attribute(value=ast.Name(id='obj', ctx=ast.Load()), attr='method1', ctx=ast.Load()), args=[], keywords=[]), attr='method2', ctx=ast.Load()), args=[], keywords=[])
...
def test_visitor_continues_traversal():
    ...
    visitor = FunctionCallVisitor()
    method_call = ast.Call(func=ast.Attribute(value=ast.Name(id='obj', ctx=ast.Load()), attr='method', ctx=ast.Load()), args=[], keywords=[])
    func2_call = ast.Call(func=ast.Name(id='func2', ctx=ast.Load()), args=[], keywords=[])
    func1_call = ast.Call(func=ast.Name(id='func1', ctx=ast.Load()), args=[func2_call, method_call], keywords=[])
