...
class TestWorkflowPhase:
    ...
    def test_duration_property_mixed_success_failure(self):
        ...
        phase.actions = [MockAction(True, 1.0), MockAction(False, 2.5), MockAction(True, 0.5)]
        assert phase.duration == 4.0
