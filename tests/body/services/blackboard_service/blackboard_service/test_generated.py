...
class TestBlackboardService:
    ...
    @pytest.mark.asyncio
    async def test_fetch_open_finding_subjects_by_prefix_empty(self, service: BlackboardService) -> None:
        ...
        with patch("body.services.service_registry.ServiceRegistry.session") as mock_session_factory:
            mock_session_factory.return_value.__aenter__.return_value = mock_session
            result = await service.fetch_open_finding_subjects_by_prefix("test::%")
            assert result == set()

    @pytest.mark.asyncio
    async def test_fetch_open_finding_subjects_by_prefix_returns_set(self, service: BlackboardService) -> None:
    ...
    @pytest.mark.asyncio
    async def test_fetch_active_finding_subjects_by_prefix_empty(self, service: BlackboardService) -> None:
    ...
    @pytest.mark.asyncio
    async def test_fetch_active_finding_subjects_by_prefix_returns_set(self, service: BlackboardService) -> None:
    ...
    @pytest.mark.asyncio
    async def test_resolve_dry_run_entries_for_namespace_zero(self, service: BlackboardService) -> None:
