    ...
    safety_rules = [
        {
            ...
            "detection": {"patterns": ["exec(", "eval(", "compile("]},
            "scope": {"exclude": []},
        }
    ]
    validator = PolicyValidator(safety_rules)
...
def test_find_dangerous_patterns_excluded_file():
    ...
    safety_rules = [
        {
            "id": "no_dangerous_execution",
            "detection": {"patterns": ["eval("]},
            "scope": {"exclude": ["/test/*.py"]},
        }
    ]
    validator = PolicyValidator(safety_rules)
...
def test_find_dangerous_patterns_mixed_rules():
    ...
    safety_rules = [
        {
            "id": "no_dangerous_execution",
            "detection": {"patterns": ["exec("]},
            "scope": {"exclude": []},
        },
        {
            "id": "no_unsafe_imports",
            "detection": {"forbidden": ["import pickle"]},
            "scope": {"exclude": []},
        },
    ]
    validator = PolicyValidator(safety_rules)
