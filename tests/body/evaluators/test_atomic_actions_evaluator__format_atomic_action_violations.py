...
class TestFormatAtomicActionViolations:
    ...
    def test_single_violation_basic(self):
        ...
        violation = type('Violation', (), {'file_path': Path('/test/file.py'), 'severity': 'error', 'function_name': 'test_function', 'line_number': 42, 'rule_id': 'RULE_001', 'message': 'Violation message here', 'suggested_fix': None})()
    ...
    def test_single_violation_verbose_with_fix(self):
        ...
        violation = type('Violation', (), {'file_path': Path('/test/file.py'), 'severity': 'warning', 'function_name': 'test_function', 'line_number': 42, 'rule_id': 'RULE_002', 'message': 'Warning message', 'suggested_fix': 'Use alternative approach'})()
    ...
    def test_multiple_violations_same_file(self):
        ...
        violations = [type('Violation', (), {'file_path': Path('/test/file.py'), 'severity': 'error', 'function_name': 'func1', 'line_number': 10, 'rule_id': 'RULE_001', 'message': 'First violation', 'suggested_fix': None})(), type('Violation', (), {'file_path': Path('/test/file.py'), 'severity': 'warning', 'function_name': 'func2', 'line_number': 20, 'rule_id': 'RULE_002', 'message': 'Second violation', 'suggested_fix': None})()]
    ...
    def test_multiple_violations_different_files(self):
        ...
        violations = [type('Violation', (), {'file_path': Path('/test/b.py'), 'severity': 'error', 'function_name': 'func_b', 'line_number': 5, 'rule_id': 'RULE_001', 'message': 'B file violation', 'suggested_fix': None})(), type('Violation', (), {'file_path': Path('/test/a.py'), 'severity': 'warning', 'function_name': 'func_a', 'line_number': 15, 'rule_id': 'RULE_002', 'message': 'A file violation', 'suggested_fix': None})()]
        result = format_atomic_action_violations(violations, verbose=False)
    ...
    def test_violation_without_line_number(self):
        ...
        violation = type('Violation', (), {'file_path': Path('/test/file.py'), 'severity': 'error', 'function_name': 'test_function', 'line_number': None, 'rule_id': 'RULE_001', 'message': 'No line number', 'suggested_fix': None})()
        result = format_atomic_action_violations([violation], verbose=False)
    ...
    def test_verbose_false_hides_suggested_fix(self):
        ...
        violation = type('Violation', (), {'file_path': Path('/test/file.py'), 'severity': 'error', 'function_name': 'test_function', 'line_number': 42, 'rule_id': 'RULE_001', 'message': 'Test message', 'suggested_fix': 'This should not appear'})()
        result = format_atomic_action_violations([violation], verbose=False)
        assert '💡 Fix:' not in result
    ...
    def test_mixed_severity_markers(self):
        ...
        violations = [type('Violation', (), {'file_path': Path('/test/file.py'), 'severity': 'error', 'function_name': 'error_func', 'line_number': 1, 'rule_id': 'RULE_001', 'message': 'Error', 'suggested_fix': None})(), type('Violation', (), {'file_path': Path('/test/file.py'), 'severity': 'warning', 'function_name': 'warning_func', 'line_number': 2, 'rule_id': 'RULE_002', 'message': 'Warning', 'suggested_fix': None})()]
        result = format_atomic_action_violations(violations, verbose=False)
