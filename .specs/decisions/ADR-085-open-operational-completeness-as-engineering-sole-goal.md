...
Remaining 5+3 items: F-27 Local LLM (partial → shipping), F-41/F-42/F-43 extension interfaces; plus three quality goals (docs polish, demo reliability, signal quality). Three of five feature commitments closed in one session.
