...
## A Founder's Statement of What CORE Must Deliver

Author: Dariusz Newecki
Classification: Founder's vision — for normative requirements see `.specs/requirements/URS-*.md`
Scope: CORE internal only

> **Editorial note (2026-07-06):** This document has been moved from
> `.specs/northstar/` to `.specs/essays/` to reflect its character as
> the founder's perspective and intent declaration, not a normative
> requirements specification. Normative, traceable requirements live in
> `.specs/requirements/URS-*.md`. This document informs the spirit behind
> those requirements and records the governing invariant from which they
> derive — it does not substitute for them.
...
The system accepts their intent as the authoritative specification and
translates it faithfully through constitutional governance.
...
The system meets that rigour with equivalent constitutional discipline.
...
Production without an established constitution is a governance violation.
The system enforces this as a precondition, not a recommendation.
