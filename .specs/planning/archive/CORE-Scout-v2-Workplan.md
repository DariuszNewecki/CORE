# CORE Scout v2 — Workplan  *(ARCHIVED 2026-07-02)*

**Status:** All GH issues closed (#685–689); B1/B3/B4 shipped (2026-06-25). Two residuals:
- **ADR-TBD-A** — Scout session artifact design, location, and governance (file after #689 runtime verify)
- **ADR-TBD-B** — CI-compatible Scout mode: amend ADR-119 D5 to allow a sanctioned non-interactive path
- **#689 runtime verify** — run two Scout passes on the same commit; confirm ≥80% rule-ID overlap (engineering fix landed 2026-06-25)
