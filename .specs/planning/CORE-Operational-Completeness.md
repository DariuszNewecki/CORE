...
- **F-40** OEM API surface — **active.** Decomposed 2026-06-02 (see §2.5). MVP path F-40.1 → F-40.2 → F-40.3 → F-40.4 (~4–5 sessions). Releases 3 commercial sidecars (F-20, F-34, F-45 read-side) on closure. **F-40.1, F-40.2, F-40.3 all ✅ closed 2026-06-02. F-40.4 (#553, sidecar verification) is the final sub-issue — closes F-40 on completion.**
