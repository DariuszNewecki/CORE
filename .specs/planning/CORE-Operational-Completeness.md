...
**Last updated:** 2026-06-06 (F-41 + F-42 + F-43 all ship — extension-interfaces trio closed. F-41 closed 2026-06-05 via ADR-091 D5 Phases 3+4. F-42 closed 2026-06-06 via ADR-091 D5 Phase 7 promotion. ADR-092 accepted 2026-06-06 amending F-43 exit criterion to action-layer registry-coupling refusal (ADR-089 precedent). F-43 closed 2026-06-06 via Option B implementation: 17 atomic actions declare artifact_type in `operational_capabilities.yaml`; `ActionExecutor.execute()` chokepoint refuses dispatch on unregistered types — verified end-to-end. **All five feature commitments now closed.** Remaining 5+3 items: three quality goals only (#561, #562, #563). Constraint in ADR-085 D1 not yet relaxed — relaxation requires governor act per D5.)
